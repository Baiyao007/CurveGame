...
namespace MyLib.Device.ParticleManager
{
    ...
    class Particle
    {
        ...
        public Particle(GraphicsDevice graphicsDevice, string name, Vector2 position, Vector2 velocity, 
            float speed, float size, float alpha, float radian, float aliveTime, IMoveAble move, float[] color)
        {
        ...
        private void InitializeBroadPolygon() {
            ...
            broadPolygon = new BroadPolygon(graphicsDevice, effect, texture, size, aliveTimer);
