    ...
    public class ParticleGroup
    {
            ...
            )
        {
            ...
            for (int i = 0; i < count; i++) {
                ...
                float size = (float)rand.Next((int)(sizeMin * 10), (int)(sizeMax * 10)) / 10;
                ...
                particles.Add(new Particle(graphicsDevice, name, position, velocity, speed, size, alpha, radian, aliveTime, move, color));
            }
        }
